...
public interface UserDetailRepository extends JpaRepository<UserDetail, Integer> {
    ...
    @Query("select new com.bal.asha.nurture.server.app.vehicle.dto.UserDetailDTO( userId, userName, idProofType, idDtls,address, mobileNo, userType,createDate) from UserDetail")
