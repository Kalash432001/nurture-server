...
public interface UserDetailRepository extends CustomRepository<UserDetail, Integer> {
    ...
    @Query("select new com.bal.asha.nurture.server.app.user.domain.UserDetailDTO( userId, userName, idProofType, idDtls,address, mobileNo, userType,createdDate) from UserDetail")
